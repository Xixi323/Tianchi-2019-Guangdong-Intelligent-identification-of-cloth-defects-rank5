...
#mkdir -p ../data/fabric/Annotation
...
wait
#cp ../data/guangdong1_round2_train_part1_20190924/Annotations/anno_train.json ../data/fabric/Annotation/anno_train_20190925.json
#cp ../data/guangdong1_round2_train2_20191004_Annotations/Annotations/anno_train.json ../data/fabric/Annotation/anno_train_20191008.json
python merage_data_json.py
python guangdong_round2.py
python guangdong_round2_100.py
#wget https://open-mmlab.oss-cn-beijing.aliyuncs.com/mmdetection/models/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth -O /content/mjcdrive/MyDrive/data/pretrained/ 
